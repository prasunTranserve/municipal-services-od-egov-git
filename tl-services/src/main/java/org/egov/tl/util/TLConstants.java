...
public class TLConstants {
    ...
    public static final String NOTIFICATION_PENDINGAPPROVAL = "tl.en.pending.approval";
    ...
    public static final String RENEWAL_NOTIFICATION_DOC_VERIFICATION = "tl.renew.en.counter.doc.verification";
    
    public static final String RENEWAL_NOTIFICATION_FORWARD_DOC_VERIFICATION = "tl.renew.en.counter.forward.doc.verification";
    ...
    public static final String NOTIFICATION_DOC_VERIFICATION = "tl.en.counter.doc.verification";
    
    public static final String NOTIFICATION_FORWARD_DOC_VERIFICATION = "tl.en.counter.forward.doc.verification";
    ...
    public static final String RENEWAL_NOTIFICATION_SENDBACK_CITIZEN= "tl.renew.en.sendback.citizen";
    ...
    public static final List<String> NOTIFICATION_CODES = Collections.unmodifiableList(Arrays.asList(
    		RENEWAL_NOTIFICATION_DOC_VERIFICATION,RENEWAL_NOTIFICATION_FORWARD_DOC_VERIFICATION,RENEWAL_NOTIFICATION_INITIATED, RENEWAL_NOTIFICATION_APPLIED, RENEWAL_NOTIFICATION_FIELD_INSPECTION, RENEWAL_NOTIFICATION_PENDINGAPPROVAL,
            RENEWAL_NOTIFICATION_REJECTED,RENEWAL_NOTIFICATION_APPROVED,RENEWAL_NOTIFICATION_SENDBACK_CITIZEN,NOTIFICATION_INITIATED,NOTIFICATION_APPLIED,NOTIFICATION_FIELD_INSPECTION,NOTIFICATION_PENDINGAPPROVAL,
            NOTIFICATION_PAYMENT_OWNER,NOTIFICATION_FORWARD_DOC_VERIFICATION,NOTIFICATION_RENEWAL_PAYMENT_OWNER,NOTIFICATION_PAYMENT_PAYER,NOTIFICATION_RENEWAL_PAYMENT_PAYER,
            ...
            NOTIFICATION_OBJECT_REMOVED,NOTIFICATION_OBJECT_MODIFIED,NOTIFICATION_DOC_VERIFICATION ,NOTIFICATION_OBJECT_RENEW_MODIFIED,NOTIFICATION_SENDBACK_CITIZEN,
    ...
    public static final String ACTION_STATUS_DOCVERIFICATION  = "PAY_DOCVERIFICATION";
    
    public static final String ACTION_STATUS_FORWARD_DOCVERIFICATION  = "FORWARD_DOCVERIFICATION";
    
    public static final String ACTION_SENDBACKTOCITIZEN_DOCVERIFICATION  = "SENDBACKTOCITIZEN_CITIZENACTIONPENDINGATDOCVERIFICATION";
    
    public static final String ACTION_SENDBACKTOCITIZEN_FIELDINSPECTION  = "SENDBACKTOCITIZEN_CITIZENACTIONPENDINGATFIVERIFICATION";
    
    public static final String ACTION_SENDBACKTOCITIZEN_PENDINGAPPROVAL  = "SENDBACKTOCITIZEN_CITIZENACTIONPENDINGATAPPROVER";
    
    public static final String ACTION_STATUS_APPROVED  = "APPROVE_APPROVED";

    public static final String ACTION_STATUS_RENEWAL_APPROVED  = "APPROVE_APPROVED";
