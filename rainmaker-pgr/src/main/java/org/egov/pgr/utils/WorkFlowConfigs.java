...
public class WorkFlowConfigs {
	...
	private static Map<String, List<String>> prepareActionCurrentStatusMap() {
		...
		map.put(ACTION_REOPEN, Arrays.asList(STATUS_REJECTED, STATUS_RESOLVED,STATUS_OPENED,STATUS_ESCALATED_LEVEL1_PENDING,STATUS_ESCALATED_LEVEL2_PENDING,STATUS_ESCALATED_LEVEL3_PENDING,STATUS_ESCALATED_LEVEL4_PENDING));
		return map;
	}
