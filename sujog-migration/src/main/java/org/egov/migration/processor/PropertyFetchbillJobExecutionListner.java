...
@Component
@Slf4j
public class PropertyFetchbillJobExecutionListner implements JobExecutionListener {
	...
	public void beforeJob(JobExecution jobExecution) {
		...
		String errorFile = errorDirectory.concat(File.separator).concat(inputFile.replace(".", "_fetchbill_error.")).replace(".", "_".concat(timestamp).concat("."));
		String successFile = successDirectory.concat(File.separator).concat(inputFile.replace(".", "_fetchbill_success.")).replace(".", "_".concat(timestamp).concat("."));
