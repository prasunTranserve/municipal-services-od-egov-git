...
public class EditNotificationService {
	...
	private EventRequest getEventRequest(WaterConnectionRequest waterConnectionRequest) {
		String localizationMessage = notificationUtil
				.getLocalizationMessages(waterConnectionRequest.getWaterConnection().getTenantId(), waterConnectionRequest.getRequestInfo());
		...
		Map<String, String> mobileNumberAndMessage = workflowNotificationService
				.getMessageForMobileNumber(mobileNumbersAndNames, waterConnectionRequest, message);
		...
		for (String mobile : mobileNumbers) {
			...
			events.add(Event.builder().tenantId(waterConnectionRequest.getWaterConnection().getTenantId())
