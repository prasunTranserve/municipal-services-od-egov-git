...
CREATE TABLE eg_mr_address(
  ...
  lastmodifiedby character varying(64),
  lastmodifiedtime bigint,
  CONSTRAINT pk_eg_mr_address PRIMARY KEY (id),
  CONSTRAINT fk_eg_mr_address FOREIGN KEY (mr_couple_id) REFERENCES eg_mr_couple (id)
  );
...
CREATE TABLE eg_mr_gaurdiandetails(
  ...
  CONSTRAINT fk_eg_mr_witness FOREIGN KEY (mr_couple_id) REFERENCES eg_mr_couple(id)
  );
