...
@Component
public class AssessmentPropertyRowMapper implements ResultSetExtractor<List<Property>> {
	...
	public List<Property> extractData(ResultSet rs) throws SQLException, DataAccessException {
		...
		while (rs.next()) {
			...
			String acknowldgementnumber = rs.getString("acknowldgementnumber");
			Property currentProperty = propertyMap.get(acknowldgementnumber);
			...
			if (null == currentProperty) {
				...
				propertyMap.put(acknowldgementnumber, currentProperty);
			}
